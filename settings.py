...
class SettingsManager:
    ...
    def load_settings(self):
        ...
        settings["performance"] = {
            "simple_style": self.settings.value("performance/simple_style", 
                                              self.DEFAULT_SETTINGS["performance"]["simple_style"], type=bool),
        ...
        # 加载外观设置
        settings["appearance"] = {
            "background_color": self.settings.value("appearance/background_color", 
                                                  self.DEFAULT_SETTINGS["appearance"]["background_color"]),
            "accent_color": self.settings.value("appearance/accent_color", 
                                              self.DEFAULT_SETTINGS["appearance"]["accent_color"]),
    ...
    def save_settings(self):
        ...
        # 保存性能设置
        self.settings.setValue("performance/simple_style", self.current_settings["performance"]["simple_style"])
        ...
        # 保存外观设置
        self.settings.setValue("appearance/background_color", self.current_settings["appearance"]["background_color"])
...
class SettingsDialog(QDialog):
    ...
    def setup_performance_tab(self):
        ...
        # 界面优化
        ui_group = QGroupBox(self.tr("settings_interface_optimization"))
        ui_layout = QFormLayout()
        
        self.simple_style_check = QCheckBox(self.tr("settings_simple_style"))
        ui_layout.addRow(self.simple_style_check)
    ...
    def setup_appearance_tab(self):
        ...
        # 颜色设置
        color_group = QGroupBox(self.tr("settings_colors"))
        ...
        color_layout.addRow(self.tr("settings_bg_color"), bg_layout)
        ...
        color_layout.addRow(self.tr("settings_accent_color"), accent_layout)
    ...
    def choose_color(self, color_type):
        ...
        if color_dialog.exec() == QDialog.DialogCode.Accepted:
            ...
            if color_type == "background":
                self.bg_color_btn.setStyleSheet(f"background-color: {color_hex};")
                self.settings_manager.current_settings["appearance"]["background_color"] = color_hex
            else:
                self.accent_color_btn.setStyleSheet(f"background-color: {color_hex};")
                self.settings_manager.current_settings["appearance"]["accent_color"] = color_hex
    ...
    def load_current_settings(self):
        ...
        # 性能设置
        self.simple_style_check.setChecked(settings["performance"]["simple_style"])
    ...
    def get_settings_from_ui(self):
        ...
        # 性能设置
        self.settings_manager.update_setting("performance", "simple_style", 
                                           self.simple_style_check.isChecked())
